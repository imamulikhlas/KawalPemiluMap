...
$combinedDataFile = $_SERVER['DOCUMENT_ROOT'] . $_ENV['API_DATA_KPU'];
            ...
            <div class="row">
                ...
                <div class="col-md-6 my-3">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center font-weight-bold">Total Suara</h5>
                            <h1 class="text-center font-weight-bold"><?php echo number_format($totalSuara, 0, '', '.'); ?></h1>
